...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("gfx/debug/console_debug.png", __ASSET__gfx_debug_console_debug_png1);
		type.set ("gfx/debug/console_debug.png", Reflect.field (AssetType, "image".toUpperCase ()));
		className.set ("gfx/debug/console_logo.png", __ASSET__gfx_debug_console_logo_png1);
		type.set ("gfx/debug/console_logo.png", Reflect.field (AssetType, "image".toUpperCase ()));
		className.set ("gfx/debug/console_output.png", __ASSET__gfx_debug_console_output_png1);
		type.set ("gfx/debug/console_output.png", Reflect.field (AssetType, "image".toUpperCase ()));
		className.set ("gfx/debug/console_pause.png", __ASSET__gfx_debug_console_pause_png1);
		type.set ("gfx/debug/console_pause.png", Reflect.field (AssetType, "image".toUpperCase ()));
		className.set ("gfx/debug/console_play.png", __ASSET__gfx_debug_console_play_png1);
		type.set ("gfx/debug/console_play.png", Reflect.field (AssetType, "image".toUpperCase ()));
		className.set ("gfx/debug/console_step.png", __ASSET__gfx_debug_console_step_png1);
		type.set ("gfx/debug/console_step.png", Reflect.field (AssetType, "image".toUpperCase ()));
		className.set ("gfx/Entities/Player.png", __ASSET__gfx_entities_player_png);
		type.set ("gfx/Entities/Player.png", Reflect.field (AssetType, "image".toUpperCase ()));
		className.set ("gfx/World/Tiles.png", __ASSET__gfx_world_tiles_png);
		type.set ("gfx/World/Tiles.png", Reflect.field (AssetType, "image".toUpperCase ()));
		className.set ("font/04B_03__.ttf", __ASSET__font_5);
		type.set ("font/04B_03__.ttf", Reflect.field (AssetType, "font".toUpperCase ()));
		className.set ("levels/0/level.oel", __ASSET__levels_0_level_oel);
		type.set ("levels/0/level.oel", Reflect.field (AssetType, "binary".toUpperCase ()));
		...
		path.set ("gfx/debug/console_step.png", "gfx/debug/console_step.png");
		type.set ("gfx/debug/console_step.png", Reflect.field (AssetType, "image".toUpperCase ()));
		path.set ("gfx/Entities/Player.png", "gfx/Entities/Player.png");
		type.set ("gfx/Entities/Player.png", Reflect.field (AssetType, "image".toUpperCase ()));
		path.set ("gfx/World/Tiles.png", "gfx/World/Tiles.png");
		type.set ("gfx/World/Tiles.png", Reflect.field (AssetType, "image".toUpperCase ()));
		className.set ("font/04B_03__.ttf", __ASSET__font_5);
		type.set ("font/04B_03__.ttf", Reflect.field (AssetType, "font".toUpperCase ()));
		path.set ("levels/0/level.oel", "levels/0/level.oel");
		type.set ("levels/0/level.oel", Reflect.field (AssetType, "binary".toUpperCase ()));
...
class __ASSET__gfx_debug_console_debug_png1 extends flash.display.BitmapData { public function new () { super (0, 0); } }
class __ASSET__gfx_debug_console_logo_png1 extends flash.display.BitmapData { public function new () { super (0, 0); } }
class __ASSET__gfx_debug_console_output_png1 extends flash.display.BitmapData { public function new () { super (0, 0); } }
class __ASSET__gfx_debug_console_pause_png1 extends flash.display.BitmapData { public function new () { super (0, 0); } }
class __ASSET__gfx_debug_console_play_png1 extends flash.display.BitmapData { public function new () { super (0, 0); } }
class __ASSET__gfx_debug_console_step_png1 extends flash.display.BitmapData { public function new () { super (0, 0); } }
class __ASSET__gfx_entities_player_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class __ASSET__gfx_world_tiles_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class __ASSET__font_5 extends flash.text.Font { }
class __ASSET__levels_0_level_oel extends flash.utils.ByteArray { }
